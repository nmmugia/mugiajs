  ...
  experience: [
    {
      ...
      description: "I Led a Sally Tribe which consists of 5 engineers, and later on Led a KMOB Line of Business which consists of 13 engineers. The systems that We’ve developed is a whole system that starts from gathering leads and potential sales, customer's data completion, surveying, KYC, and finally into a final process of financing approval. ",
    },
    {
      company: "Cybersecurity Software Engineer at Microsec Pte LTD",
      role: "Singapore (Remotely)",
      period: "Dec 2022 - May 2023",
      description: "Microsec is a cybersecurity company that focuses on providing secure solution for IoT.",
    },
    {
